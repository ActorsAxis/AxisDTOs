//
//  CurrentlyFilmingEpisodeDTOs.swift
//  AxisDTOs
//
...
public struct CurrentlyFilmingEpisodeRequest: Codable, Sendable {
	public var id:         UUID?
	...
	public init(from response: CurrentlyFilmingEpisodeResponse) {
		id         = response.id
		name       = response.name
...
public struct CurrentlyFilmingEpisodeResponse: Codable,  Sendable,
	...
	public mutating func copyNonOptionals(from request: CurrentlyFilmingEpisodeRequest) {
